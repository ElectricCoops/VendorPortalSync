...
@NamedQueries({ @NamedQuery(name = "BiWrkflwTask.findAll", query = "SELECT b FROM BiWrkflwTask b"),
		@NamedQuery(name = "BiWrkflwTask.findWFTaskByWF", query = "SELECT b FROM BiWrkflwTask b WHERE b.biWrkflwKey = :biWrkflwKey"),
		@NamedQuery(name = "BiWrkflwTask.findWFTaskByWO", query = "SELECT b FROM BiWrkflwTask b WHERE b.biWoWorkord = :workOrderId"),
		@NamedQuery(name = "BiWrkflwTask.findWFTaskByWFTask", query = "SELECT b FROM BiWrkflwTask b WHERE b.biWrkflwTasksKey = :biWrkflwTasksKey") })
public class BiWrkflwTask implements Serializable {
	private static final long serialVersionUID = 1L;
	@Id
	@Column(name = "BI_WRKFLW_TASKS_KEY")
	private int biWrkflwTasksKey;
	...
	@Column(name = "BI_LOC_KEY_1")
	private String biLocKey1;
	@Column(name = "BI_LOC_KEY_2")
	private String biLocKey2;
	...
	@Column(name = "BI_TASK_CD", insertable = false, updatable = false)
	...
	private String biWrkflwTaskSeqNbr;
	@Column(name = "BI_WRKFLW_TASKS_CTR")
	private int biWrkflwTasksCtr;
	...
	@Column(name = "SY_USER_ID", insertable = false, updatable = false)
	...
	public int getBiWrkflwTasksKey() {
		return this.biWrkflwTasksKey;
	}

	public void setBiWrkflwTasksKey(int biWrkflwTasksKey) {
	...
	public String getBiLocKey1() {
		return this.biLocKey1;
	}

	public void setBiLocKey1(String biLocKey1) {
		this.biLocKey1 = biLocKey1;
	}

	public String getBiLocKey2() {
		return this.biLocKey2;
	}

	public void setBiLocKey2(String biLocKey2) {
		this.biLocKey2 = biLocKey2;
	}
	...
	public String getBiWrkflwTaskSeqNbr() {
		return this.biWrkflwTaskSeqNbr;
	}

	public void setBiWrkflwTaskSeqNbr(String biWrkflwTaskSeqNbr) {
		this.biWrkflwTaskSeqNbr = biWrkflwTaskSeqNbr;
	}

	public int getBiWrkflwTasksCtr() {
		return this.biWrkflwTasksCtr;
	}

	public void setBiWrkflwTasksCtr(int biWrkflwTasksCtr) {
